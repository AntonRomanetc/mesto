...
export const formInputAbout = popupActionEdit.querySelector('.form__input_data_about');
export const popupActionEditAvatar = document.querySelector('.popup_action_edit-avatar');
export const formEditAvatar = popupActionEditAvatar.querySelector('.form_action_edit-avatar');
...
export const popupDeleteSelector = '.popup_action_delete-card';
export const popupEditAvatarSelector = '.popup_action_edit-avatar';
